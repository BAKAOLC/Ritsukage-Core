...
namespace Ritsukage.QQ
{
    public static class SoraApiExtension
    {
        ...
        {
            return Convert.ToBoolean((await api.GetGroupMemberList(group))
