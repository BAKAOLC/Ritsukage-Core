...
namespace Ritsukage.Library.Minecraft.Changelog
{
    ...
    {
        private const string Host = "https://feedback.minecraft.net";

        private const string MC_Beta =
            "https://feedback.minecraft.net/hc/en-us/sections/360001185332-Beta-Information-and-Changelogs";

        private const string MC_Release =
            "https://feedback.minecraft.net/hc/en-us/sections/360001186971-Release-Changelogs";

        private const string MC_Snapshot =
        ...
        public ArticleList(string type)
        {
            ...
            foreach (var article in articlesMatch.Cast<Match>())
