...
namespace Ritsukage.Library.Data
{
    ...
    public class Ci_Song_Author
    {
        ...
        [Column("ShortDescription")] public string ShortDescription { get; set; }
    }
    ...
    public class Poetry_Song
    {
        ...
        [Column("Paragraphs")] public string Paragraphs { get; set; }

        [Column("Strains")] public string Strains { get; set; }
    }
