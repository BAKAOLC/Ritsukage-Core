...
namespace Ritsukage.Library.Hibi
{
    public class HibiPixiv : HibiApi
    {
        ...
        {
            return Get("/api/pixiv/illust", new()
            {
                { "id", id },
            });
        }
        ...
        {
            return Get("/api/pixiv/member", new()
            {
                { "id", id },
            });
        }
        ...
        {
            return Get("/api/pixiv/member_illust", new()
            {
                { "id", id },
        ...
        {
            return Get("/api/pixiv/search", new()
            {
                { "word", word },
                { "mode", type.ToString("G").ToLower() },
        ...
        {
            return Get("/api/pixiv/ugoira_metadata", new()
            {
                { "id", id },
            });
        }
