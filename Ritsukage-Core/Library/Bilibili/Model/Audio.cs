...
namespace Ritsukage.Library.Bilibili.Model
{
    public class Audio
    {
        ...
        public string Url => "https://www.bilibili.com/audio/au" + Id;
        ...
        {
            var info = JObject.Parse(Utils.HttpGET("https://www.bilibili.com/audio/music-service-c/web/song/info?sid=" +
                                                   id));
            if ((int)info["code"] != 0)
                throw new((string)info["msg"]);
