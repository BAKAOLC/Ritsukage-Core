...
namespace Ritsukage.Library.Subscribe.Listener
{
    public partial class MinecraftVersionListener : Base.SubscribeListener
    {
        ...
        private readonly MinecraftVersionCheckMethod Checker = new();
        ...
        private static string GetString(MinecraftVersionCheckResult result)
        {
                ...
                case "rc":
                    try
                    {
                        ...
                        var article = articles.Articles.Where(x => (x.Key.Contains(mainVersion)
                                ...
                                : subType == "rc" && x.Key.Contains("Release Candidate")) && x.Key.Contains(subNum)))
                            .FirstOrDefault();
