...
namespace Ritsukage.Tools
{
    public class ByteDataBuilder
    {
        ...
        public void Write(short value, bool overwrite = true)
        {
            Write(GetBytes(value), overwrite);
        }

        public void Write(int value, bool overwrite = true)
        {
            Write(GetBytes(value), overwrite);
        }

        public void Write(long value, bool overwrite = true)
        {
            Write(GetBytes(value), overwrite);
        }

        public void Write(string value, bool overwrite = true)
        {
            Write(GetBytes(value), overwrite);
        }
